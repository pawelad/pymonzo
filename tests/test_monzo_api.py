...
class TestMonzoAPI:
    ...
    def test_class_accounts_method(self, mocker, mocked_monzo, accounts_api_response):
        ...
        expected_result = [MonzoAccount(data=account) for account in accounts_json]
    ...
    def test_class_balance_method(
        self, mocker, mocked_monzo, balance_api_response, accounts_api_response
    ):
    ...
    def test_class_transactions_method(
        self, mocker, mocked_monzo, transactions_api_response, accounts_api_response
    ):
    ...
    def test_class_transaction_method(
        self, mocker, mocked_monzo, transaction_api_response
    ):
